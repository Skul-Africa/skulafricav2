        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="mt-20 relative max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-500">
            ...
            <div className="relative bg-neutral-900 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="aspect-[16/9] bg-neutral-900 pt-12 flex items-center justify-center text-neutral-700">
                <div className="text-center">
                  <Layout className="w-24 h-24 mx-auto mb-4 opacity-20" />
                  <p className="text-lg font-medium opacity-40">Interactive Dashboard Preview</p>
                </div>
              </div>
            </div>
          </div>
