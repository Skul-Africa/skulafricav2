                ...
                {filteredStudents.map((student) => (
                  <tr key={student.id} className="border-b border-neutral-800">
                    ...
                    <td className="py-3 px-4">
                      <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${attendance[student.id] === 'present'
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center space-x-2">
                        <Button
                          ...
                          className={`text-green-400 hover:text-green-300 hover:bg-green-900/20 ${attendance[student.id] === 'present' ? 'bg-green-900/20' : ''
                            }`}
                        >
                        ...
                        <Button
                          ...
                          className={`text-red-400 hover:text-red-300 hover:bg-red-900/20 ${attendance[student.id] === 'absent' ? 'bg-red-900/20' : ''
                            }`}
                        >
